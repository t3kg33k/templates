...
# regex_mac_exclusions.append("00:00:5e:00:53:af")
regex_mac_exclusions.append("^52:.*")
#regex_mac_exclusions.append("^52:54:00:.*")
# ===========================

# variable containing the filepath of the nmap scan results file
mac_list = os.environ['HOME'] + "/bin/maclist.txt"

# variable containing the filepath of the approved mac addresses on the LAN file
masterfile = os.environ['HOME'] + "/bin/master_mac.txt"

# If a file from previous nmap scans exists, create a backup of the file
if os.path.exists(mac_list):
    shutil.copyfile(mac_list, os.environ['HOME'] + '/bin/nmapscans/maclist_' + datetime.now().strftime("%Y_%m_%H%M") + '.log.bk')
